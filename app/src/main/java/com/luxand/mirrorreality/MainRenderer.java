...
public class MainRenderer implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public static final int [][] MASKS = new int[][]
    {
            ...
            {R.raw.glass1, R.drawable.catg1, R.drawable.catg1, MR.SHIFT_TYPE_NO},
            {R.raw.glass1, R.drawable.catg2, R.drawable.catg2, MR.SHIFT_TYPE_NO},
            {R.raw.glass1, R.drawable.catg3, R.drawable.catg3, MR.SHIFT_TYPE_NO},
            {R.raw.glass1, R.drawable.glass6, R.drawable.glass6, MR.SHIFT_TYPE_NO}
